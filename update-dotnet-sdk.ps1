...
if ($DryRun) {
    ...
    if ($env:CI -And $GitHubToken) {
        ...
        $Body = @{
            ...
            "head"                  = $BranchName;
            "base"                  = $Base;
            "body"                  = "Updates the .NET SDK to version [``$LatestSDKVersion``](https://github.com/dotnet/core/blob/master/release-notes/$Channel/$LatestRuntimeVersion/$LatestSDKVersion-download.md), which includes version ``$LatestRuntimeVersion`` of the .NET runtime.`n`nThis pull request was auto-generated by [GitHub Actions](https://github.com/$env:GITHUB_REPOSITORY/actions/runs/$env:GITHUB_RUN_ID).";
